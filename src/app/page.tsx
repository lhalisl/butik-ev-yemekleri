    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{ backgroundImage: "url('/brand_assets/restaurant_interior_hazal_1779105131583.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-6 py-32">
            <span className="inline-block text-xs font-semibold tracking-[0.2em] uppercase text-gold border border-gold/30 bg-gold/10 px-4 py-2 rounded-full mb-6">
              Şef Hazal Demir İmzalı
            </span>
            <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6" style={{ fontFamily: 'var(--font-heading)' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/menu"
                className="bg-burgundy hover:bg-burgundy-dark text-white px-8 py-4 rounded-full text-base font-bold shadow-lg transition-all"
              >
                Hemen Sipariş Ver
              </Link>
              <Link
                href="/menu"
                className="border border-white/60 hover:border-white text-white px-8 py-4 rounded-full text-base font-medium transition-all"
              >
                Menüyü Gör
              </Link>
            </div>
        ...
        {/* ── ABOUT ── */}
        <section id="hakkimizda" className="py-24 bg-cream">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-xs font-semibold tracking-[0.18em] uppercase text-burgundy mb-3 block">Hakkımızda</span>
              <h2 className="text-4xl md:text-5xl font-bold text-green mb-6 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  <li key={v} className="flex items-center gap-3 text-muted text-sm border-b border-text/8 pb-3">
                    <span className="w-2 h-2 rounded-full bg-gold flex-shrink-0" />
                    {v}
                  </li>
                ))}
              </ul>
              <Link href="/menu" className="inline-block bg-green hover:bg-green-mid text-white px-6 py-3 rounded-full font-semibold transition-all text-sm">
                Menüyü Keşfet
              </Link>
            </div>
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-5 -left-5 w-20 h-20 bg-cream rounded-full border-2 border-gold/30 p-1.5 shadow-lg">
        ...
        <section
          ...
          style={{ backgroundImage: "url('/brand_assets/kuzu_tandir_meal_1779105065583.png')", backgroundSize: 'cover', backgroundPosition: 'center right' }}
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-xs font-semibold tracking-[0.18em] uppercase text-gold mb-4 block">İmza Yemek</span>
              <h2 className="text-5xl md:text-6xl font-bold text-gold mb-4 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
                Kuzu But<br />Tandır
              </h2>
              <p className="text-white/75 text-base leading-relaxed mb-6">
                300 gramlık kuzu but, saatlerce tütsüde sabırla pişirilir. Her lokmasında Şef Hazal'ın imzasını hissedersiniz.
              </p>
              <div className="text-white text-5xl font-bold mb-1" style={{ fontFamily: 'var(--font-heading)' }}>
                450 <span className="text-2xl opacity-60">₺</span>
              </div>
              <p className="text-gold text-sm mb-8">Pilav &nbsp;•&nbsp; Salata &nbsp;•&nbsp; Ayran dahil</p>
              <Link
                href="/menu"
                className="inline-block bg-gold hover:bg-gold-light text-green-dark px-8 py-4 rounded-full font-bold shadow-lg transition-all"
              >
                Hemen Sipariş Ver
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={b.title} className="text-center">
                  <div className="w-16 h-16 rounded-full border border-gold/30 bg-gold/10 flex items-center justify-center text-gold mx-auto mb-4">
                    {b.icon}
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                ...
                <div key={r.name} className="bg-card rounded-2xl p-6 shadow-sm border border-text/8">
        ...
        <section id="iletisim" className="py-24 bg-green-dark text-white">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold mb-8" style={{ fontFamily: 'var(--font-heading)' }}>Bize Ulaşın</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <Link href="/menu" className="bg-burgundy hover:bg-burgundy-dark text-white px-6 py-3 rounded-full font-bold text-sm text-center transition-all">
                  Online Sipariş Ver
                </Link>
                <a
                  ...
                  className="border border-gold/40 text-gold-light hover:border-gold text-center px-6 py-3 rounded-full text-sm transition-all"
                >
                  Haritada Gör
                </a>
              </div>
            </div>
            <div className="bg-green/30 border border-gold/20 rounded-2xl p-8 flex flex-col items-center text-center gap-4">
              ...
              <Link
                href="/menu"
                className="bg-gold hover:bg-gold-light text-green-dark font-bold px-6 py-3 rounded-full text-sm transition-all"
              >
                Sipariş Ver
              </Link>
            </div>
